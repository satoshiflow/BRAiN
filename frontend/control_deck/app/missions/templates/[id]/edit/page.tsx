...
import { useTemplate, useUpdateTemplate } from "@/hooks/useMissionTemplates";
...
export default function EditTemplatePage() {
  ...
  useEffect(() => {
    if (template) {
      ...
      setVariables(
        Object.entries(template.variables || {}).map(([name, def]) => ({
          name,
          def,
        }))
      );
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button
            ...
            disabled={isSubmitDisabled || updateMutation.isPending}
